...
func (sf *SingleFlight[_]) Name() string {
	return sf.name
}
...
func (sf *SingleFlight[_]) SetLogger(log slog.Logger) {
	sf.mu.Lock()
	defer sf.mu.Unlock()
...
func (sf *SingleFlight[_]) withLogger(level slog.LogLevel) (slog.Logger, bool) {
	if sf.log != nil {
...
func (sf *SingleFlight[_]) withDebug() (slog.Logger, bool) {
